...
static const char *fonts[]          = { "Comic Sans MS:weight=bold:size=12:antialias=true:autohint=true",
...
static const char *brighup[] = {"xrandar", "--output", "eDP-1", "brightness", "0.9"};
static const char *brighdwn[] = {"xrandar", "--output", "eDP-1", "brightness", "0.5"};
...
static const Key keys[] = {
	...
	{ 0, XF86XK_MonBrightnessUp, spawn,  {.v = brighup} },
	{ 0, XF86XK_MonBrightnessDown, spawn,  {.v = brighdwn} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
